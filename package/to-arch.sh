...
# Deletes sway config cuz sway edition saves its configs in a packagesprintf "Would you like to reboot? (y/N)"
read -r reboot and sway gets borked after deleteing those.
